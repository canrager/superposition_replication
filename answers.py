...
# %% Cosine similarity - how much do features overlap?
...
# %% Choose varying parameters for importance and sparsity
config = Config(
    n_instances = 10,
    n_features = 5,
    n_hidden = 2,
...
# The bar plit on the left shows how many features are actually represented 
# The right bar plot shows dot product of itself and the norm. Cosine similarity would be more informative here.
...
# %% Inspect correlated and uncorrelated features
config = Config(
    n_instances = 10,
    n_features = 4,
    n_hidden = 2,
...
# %% Test generate_correlated_samples statistically
...
# %% correlated features are encoded orthogonal to each other
config = Config(
    n_instances = 5,
    n_features = 4,
    n_hidden = 2,
...
# %% anticorrelated features are encoded antiproportional to each other
...
# %% correlated features side by side
